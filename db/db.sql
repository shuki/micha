...
-- Dumping structure for table base.demo
...
-- Dumping data for table base.demo: ~0 rows (approximately)
/*!40000 ALTER TABLE `demo` DISABLE KEYS */;
/*!40000 ALTER TABLE `demo` ENABLE KEYS */;


-- Dumping structure for table base.jset_atom
...
-- Dumping data for table base.jset_atom: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_atom` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_atom` ENABLE KEYS */;


-- Dumping structure for table base.jset_column
...
-- Dumping data for table base.jset_column: ~73 rows (approximately)
...
-- Dumping structure for table base.jset_default_column
...
-- Dumping data for table base.jset_default_column: ~1 rows (approximately)
...
-- Dumping structure for table base.jset_error
...
-- Dumping data for table base.jset_error: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_error` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_error` ENABLE KEYS */;


-- Dumping structure for table base.jset_event
...
-- Dumping data for table base.jset_event: ~2 rows (approximately)
...
-- Dumping structure for table base.jset_host
...
-- Dumping data for table base.jset_host: ~1 rows (approximately)
...
REPLACE INTO `jset_host` (`id`, `active`, `name`, `host`, `port`, `server`, `db_name`, `user`, `password`) VALUES
	(1, 1, 'localhost', 'localhost', '3306', 'mysql', 'base', 'root', NULL);
/*!40000 ALTER TABLE `jset_host` ENABLE KEYS */;


-- Dumping structure for table base.jset_lang
...
-- Dumping data for table base.jset_lang: ~4 rows (approximately)
...
-- Dumping structure for table base.jset_lang_item
...
-- Dumping data for table base.jset_lang_item: ~30 rows (approximately)
...
-- Dumping structure for table base.jset_layout
...
-- Dumping data for table base.jset_layout: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_layout` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_layout` ENABLE KEYS */;


-- Dumping structure for table base.jset_list
...
-- Dumping data for table base.jset_list: ~18 rows (approximately)
...
-- Dumping structure for table base.jset_login
...
-- Dumping data for table base.jset_login: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_login` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_login` ENABLE KEYS */;


-- Dumping structure for table base.jset_log_demo_
DROP TABLE IF EXISTS `jset_log_demo_`;
CREATE TABLE IF NOT EXISTS `jset_log_demo_` (
...
-- Dumping data for table base.jset_log_demo_: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_log_demo_` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_log_demo_` ENABLE KEYS */;


-- Dumping structure for table base.jset_semaphore
...
-- Dumping data for table base.jset_semaphore: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_semaphore` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_semaphore` ENABLE KEYS */;


-- Dumping structure for table base.jset_sql
...
-- Dumping data for table base.jset_sql: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_sql` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_sql` ENABLE KEYS */;


-- Dumping structure for table base.jset_table
...
-- Dumping data for table base.jset_table: ~6 rows (approximately)
...
REPLACE INTO `jset_table` (`id`, `name`, `section`, `description`, `title`, `source`, `target`, `help`, `validation`, `system`) VALUES
	...
	(28, 'demo', NULL, NULL, 'משימות לביצוע', 'v_demo', 'demo', NULL, NULL, 0);
/*!40000 ALTER TABLE `jset_table` ENABLE KEYS */;


-- Dumping structure for table base.jset_upload
...
-- Dumping data for table base.jset_upload: ~0 rows (approximately)
/*!40000 ALTER TABLE `jset_upload` DISABLE KEYS */;
/*!40000 ALTER TABLE `jset_upload` ENABLE KEYS */;


-- Dumping structure for view base.v_demo
...
-- Dumping structure for table base.worker
...
-- Dumping data for table base.worker: 1 rows
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` VIEW `v_demo` AS select 
	`id`,
	`created_on`,
	`name`,
	`project`,
